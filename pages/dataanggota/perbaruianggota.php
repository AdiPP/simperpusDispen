...
<head>
  ...
  <title>SIMPERPUS | Perbarui Anggota</title>
    ...
    <section class="content">
      <div class="row">
        <?php
         ...
         ?>
        <form class="form-horizontal" role="form" method="post" action="perbaruianggota-proses.php">
        <div class="col-xs-12">
        </div>
          <div class="col-md-12">
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">Perbarui Anggota</h3>
              </div>
              <!-- /.box-header -->
                <div class="box-body">
                  <div class="col-xs-12">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-xs-10">
                        <input value="<?php echo $a['nama_anggota'] ?>" type="text" class="form-control" id="namaanggota" name="namaanggota" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="" class="col-sm-2 control-label">Tempat Lahir</label>
                      <div class="col-xs-3">
                        <input value="<?php echo $a['tempat_lahir'] ?>" type="text" class="form-control" id="tempatlahir" name="tempatlahir" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="" class="col-sm-2 control-label">Tanggal Lahir</label>
                      <div class="col-xs-3">
                        <input value="<?php echo $a['tanggal_lahir']; ?>" type="date" class="form-control" id="tanggallahir" name="tanggallahir" required>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-xs-2">
                        <select class="form-control" name="jeniskelamin" required>
                          ...
                          <option <?php if ($a['jns_klmn'] == 'Laki-laki') {
                            echo "selected";
                          } ?>>Laki-laki</option>
                          <option <?php if ($a['jns_klmn'] == 'Perempuan') {
                            echo "selected";
                          } ?>>Perempuan</option>
                        </select>
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-xs-2">
                        <input value="<?php echo $a['telp']; ?>" type="text" class="form-control" id="telepon" name="telepon" onkeypress="isInputNumber(event)" maxlength="13" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="" class="col-sm-2 control-label">NIK</label>
                      <div class="col-xs-3">
                        <input value="<?php echo $a['nik']; ?>" type="text" class="form-control" id="nik" name="nik" onkeypress="isInputNumber(event)" maxlength="16" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="" class="col-sm-2 control-label">Pekerjaan</label>
                      <div class="col-xs-4">
                        <input value="<?php echo $a['pkrjaan']; ?>" type="text" class="form-control" id="pekerjaan" name="pekerjaan" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="alamat" class="col-sm-2 control-label">Alamat</label>
                      <div class="col-xs-6">
                        <textarea class="form-control" rows="3" name="alamat" required><?php echo $a['alamat']; ?></textarea>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-xs-12 text-center">
            <a href="dataanggota.php" class="btn btn-default" style="margin-right: 20px;">Kembali ke Data Anggota</a>
