...
<head>
  ...
  <title>SIMPERPUS | Data Anggota</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="alert alert-danger alert-dismissible" style="<?php echo $display ?>">
        ...
        Data anggota tidak dapat dihapus, karena sudah pernah dilibatkan dalam transaksi.
      </div>
      <div class="row">
        <div class="col-xs-12">
          <a href="tambahanggota.php" class="btn btn-default margin-bottom" style="margin-right: 20px;"><i class="fa fa-user-plus"></i> Tambah Anggota</a>
          <a href="reportdataanggota.php" class="btn btn-default margin-bottom pull-right"><i class="glyphicon glyphicon-print"></i> Laporan Anggota</a>
        </div>
        <!-- /.col -->
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                  $nomor = 1;
                  $anggota = mysqli_query($koneksi,"SELECT * FROM t_dataanggota ORDER BY id_anggota DESC");
                ...
                <tr>
                  ...
                  <td width="120px">
                    <div style="text-align: center;">
                      <a href="informasianggota.php?id=<?php echo $a['id_anggota'] ?>" class="btn btn-info btn-xs btn-flat" style="margin: 0 5px 0 0;"><i class="fa fa-eye"></i></a>
                      <a href="perbaruianggota.php?id=<?php echo $a['id_anggota'] ?>" class="btn btn-default btn-xs btn-flat" style="margin: 0 5px 0 0;"><i class="fa fa-pencil"></i></a>
                      <a onclick="deleteme(<?php echo $a['id_anggota']; ?>)" class="btn btn-danger btn-xs btn-flat" style="margin: 0 5px 0 0;"><i class="fa fa-trash"></i></a>
                    </div>
                  </td>
                </tr>
                <?php
