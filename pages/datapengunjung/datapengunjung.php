...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <a href="reportdatapengunjung.php" class="btn btn-default margin-bottom pull-right"><i class="glyphicon glyphicon-print"></i> Laporan Pengunjung</a>
        </div>
        <!-- /.col -->
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                    $nomor = 1;
                    $pengunjung = mysqli_query($koneksi,"SELECT * FROM t_datapengunjung ORDER BY id_pgnjng DESC");
                    while ($dpeng = mysqli_fetch_array($pengunjung)) {
                   ?>
                <tr>
                  <td align="center"><?php echo $nomor; ?>.</td>
                  <td><?php echo $dpeng['nama_pgnjng']; ?></td>
                  <td><?php echo $dpeng['pkrjaan']; ?></td>
                  <td><?php echo $dpeng['kprluan']; ?></td>
                  <td><?php
                  $tanggal = date("d/m/y", strtotime($dpeng['tgl']));
                  echo $tanggal;
                  ?></td>
                </tr>
                  <?php
