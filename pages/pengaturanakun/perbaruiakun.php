...
<head>
  ...
  <title>SIMPERPUS | Perbarui Akun</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Perbarui Akun</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        <?php
         ...
         ?>
        <form class="form-horizontal" role="form" method="post" action="perbaruiakun-proses.php">
        <div class="col-xs-12">
        </div>
          <div class="col-md-12">
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">Perbarui Akun</h3>
              </div>
              <!-- /.box-header -->
                <div class="box-body">
                  <div class="col-xs-12">
                    ...
                    <div class="form-group">
                      <label for="" class="col-sm-2 control-label">Nama Pengguna</label>
                      <div class="col-xs-10">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-xs-3">
                        <input value="<?php echo $a['nip'] ?>" type="number" class="form-control" id="nip" name="nip" required>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-xs-12 text-center">
            <a href="pengaturanakun.php" class="btn btn-default" style="margin-right: 20px;">Kembali</a>
