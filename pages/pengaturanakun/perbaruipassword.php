...
<?php
  ...
  if (isset($_GET['pesan'])) {
    $display = "";
    if ($_GET['pesan'] == "passwordlamasalah") {
      $pesan = "Password lama salah.";
    } elseif ($_GET['pesan'] == "passwordtidaksama") {
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Perbarui Password</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="row">
        <?php
         ...
         ?>
        <form class="form-horizontal" role="form" method="post" action="perbaruipassword-proses.php">
        <div class="col-xs-12">
        </div>
          <div class="col-md-12">
                ...
                <div class="box-body">
                  <div class="col-xs-12">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-xs-3">
                        <input type="password" class="form-control" id="nip" name="passwordbaru" required>
                      </div>
                    </div>
                    <div class="form-group">
