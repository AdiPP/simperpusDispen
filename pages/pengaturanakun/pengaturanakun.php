...
<head>
  ...
  <title>SIMPERPUS | Informasi Akun</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="pad margin no-print">
      <div class="callout callout-info" style="margin-bottom: 0!important;">
        ...
        <b>Tombol Perbarui</b> digunakan untuk memperbarui informasi akun. <b>Tombol Perbarui Password</b> digunakan untuk memperbarui password akun.
      </div>
    </div>
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            ...
            <small class="pull-right">ID Pengguna: #<?php echo $p['id_pengguna'] ?></small>
          </h2>
        </div>
        <!-- /.col -->
      </div>
        ...
        <div class="col-xs-12">
          <div class="table-responsive">
            <table class="table table-striped">
              <tr>
                <th style="width:50%">ID Pengguna </th>
                <td>#<?php echo $p['id_pengguna'] ?></td>
              </tr>
              <tr>
                <th>Nama</th>
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          <a href="perbaruiakun.php?id=<?php echo $id ?>" class="btn btn-info pull-right" style="margin-left: 5px;">Perbarui</a>
          <a href="perbaruipassword.php?id=<?php echo $id ?>" class="btn btn-default pull-right">Perbarui Password</a>
        </div>
      </div>
      <?php
        }
