...
<?php
  ...
  if (isset($_GET['pesan'])) {
    if (isset($_GET['pesan']) == "usernametidaktersedia") {
      $display = "";
      $pesan = "Username sudah pernah digunakan.";
    }
  }
...
<head>
  ...
  <title>SIMPERPUS | Tambah Admin</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        <form class="form-horizontal" role="form" method="post" action="tambahadmin-proses.php">
        <div class="col-xs-12">
        </div>
          <div class="col-md-12">
                ...
                <div class="box-body">
                  <div class="col-xs-12">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-xs-3">
                        <input type="text" class="form-control" id="nip" name="nip" onkeypress="isInputNumber(event)" maxlength="18" required>
                      </div>
                    </div>
                    <div class="form-group">
