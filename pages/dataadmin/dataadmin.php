...
<?php
  ...
  if (isset($_GET['pesan'])) {
    ...
    if ($_GET['pesan'] == "berhasil") {
      $idadmin = $_GET['id'];
      $admin = mysqli_query($koneksi,"SELECT * FROM t_datapengguna WHERE id_pengguna = $idadmin");
      $dadmin = mysqli_fetch_assoc($admin);
      $namaadmin = $dadmin['nama_pengguna'];
      $pesan = "Data Admin ".$namaadmin." berhasil diatur ulang.";
    }
  }
...
<head>
  ...
  <title>SIMPERPUS | Data Admin</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active" style="<?php if ($d['level'] == 2) {
          echo $displaynone;
        } ?>">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="alert alert-success alert-dismissible" style="<?php echo $display; ?>">
      ...
      <div class="row">
        <div class="col-xs-12">
          <a href="tambahadmin.php" class="btn btn-default margin-bottom" style="margin-right: 20px;"><i class="fa fa-plus"></i> Tambah Admin</a>
          <a href="reportdataadmin.php" class="btn btn-default margin-bottom pull-right"><i class="glyphicon glyphicon-print"></i> Laporan Admin</a>
        </div>
        <!-- /.col -->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Admin Perpustakaan</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                    $nomor = 1;
                    $admin = mysqli_query($koneksi, "SELECT * FROM t_datapengguna WHERE level = 2 ORDER BY id_pengguna DESC");
                ...
                <tr>
                  ...
                  <td width="120px">
                    <div style="text-align: center;">
                      <a href="informasiadmin.php?id=<?php echo $p['id_pengguna'] ?>" class="btn btn-info btn-xs btn-flat" style="margin: 0 5px 0 0;"><i class="fa fa-eye"></i></a>
                      <a href="perbaruiadmin.php?id=<?php echo $p['id_pengguna']; ?>" class="btn btn-default btn-xs btn-flat" style="margin: 0 5px 0 0;"><i class="fa fa-pencil"></i></a>
                      <a href="resetadmin.php?id=<?php echo $p['id_pengguna']; ?>" class="btn btn-warning btn-xs btn-flat" style="margin: 0 5px 0 0;"><i class="fa fa-refresh"></i></a>
                      <a onclick="deleteme(<?php echo $p['id_pengguna']; ?>)" class="btn btn-danger btn-xs btn-flat" style="margin: 0 5px 0 0;"><i class="fa fa-trash"></i></a>
                    </div>
                  </td>
                </tr>
              <?php
...
<script type="text/javascript">
  function deleteme(delid){
    if (confirm("Yakin ingin menghapus?")) {
      window.location.href='hapusadmin-proses.php?del_id=' +delid+'';
      return true;
    }
  }
</script>
