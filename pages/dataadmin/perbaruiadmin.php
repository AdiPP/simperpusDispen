...
<head>
  ...
  <title>SIMPERPUS | Perbarui Admin</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="datapustaka.php">Data Admin</a></li>
    ...
    <section class="content">
      <div class="row">
        <?php
          $admin = mysqli_query($koneksi, "SELECT * FROM t_datapengguna WHERE id_pengguna = '$id'");
          while ($a = mysqli_fetch_array($admin)) {
         ?>
        <form class="form-horizontal" role="form" method="post" action="perbaruiadmin-proses.php">
        <div class="col-xs-12">
        </div>
          <div class="col-md-12">
            ...
            <div class="box box-primary">
              ...
              <!-- /.box-header -->
                <div class="box-body">
                  <div class="col-xs-12">
                    <input value="<?php echo $a['id_pengguna'] ?>" type="hidden" name="id">
                    <div class="form-group">
                      <label for="" class="col-sm-2 control-label">Nama Admin</label>
                      <div class="col-xs-10">
                        <input value="<?php echo $a['nama_pengguna'] ?>" type="text" class="form-control" id="namaadmin" name="namaadmin" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="" class="col-sm-2 control-label">NIP</label>
                      <div class="col-xs-3">
                        <input value="<?php echo $a['nip'] ?>" type="text" class="form-control" id="nip" name="nip" onkeypress="isInputNumber(event)" maxlength="18" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="" class="col-sm-2 control-label">Username</label>
                      <div class="col-xs-4">
                        <input value="<?php echo $a['username'] ?>" type="text" class="form-control" id="username" name="username" disabled required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="" class="col-sm-2 control-label">Password</label>
                      <div class="col-xs-4">
                        <input value="<?php echo $a['password']; ?>" type="password" class="form-control" id="password" name="password" disabled required>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-xs-12 text-center">
            <a href="dataadmin.php" class="btn btn-default" style="margin-right: 20px;">Kembali ke Data Admin</a>
