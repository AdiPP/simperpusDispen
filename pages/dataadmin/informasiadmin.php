...
<head>
  ...
  <title>SIMPERPUS | Informasi Admin</title>
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            ...
            <small class="pull-right">ID Admin: #<?php echo $p['id_pengguna'] ?></small>
          </h2>
        </div>
        <!-- /.col -->
      </div>
      ...
      <div class="row no-print">
        <div class="col-xs-12 text-center">
          <a href="dataadmin.php" class="btn btn-default" style="margin-right: 10px;">Kembali</a>
          <a onclick="deleteme(<?php echo $p['id_pengguna']; ?>)" class="btn btn-danger">Hapus</a>
        </div>
      </div>
      <?php
        }
