...
<?php
  ...
  if (isset($_GET['pesan'])) {
    if ($_GET['pesan'] == "tidakditemukan") {
      $display = "";
      $pesan = "Nomor Pustaka dan Nomor Anggota tidak ditemukan.";
    } elseif ($_GET['pesan'] == "anggotatidakditemukan") {
      $display = "";
      $pesan = "Nomor Anggota tidak ditemukan.";
    } elseif ($_GET['pesan'] == "pustakatidakditemukan") {
      $display = "";
      $pesan = "Nomor Pustaka tidak ditemukan.";
    }
  }
...
<head>
  ...
  <title>SIMPERPUS | Tambah Peminjaman</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        <form class="form-horizontal" role="form" method="post" action="tambahpeminjaman-cekdata.php">
        <div class="col-xs-12">
        </div>
          <div class="col-md-12">
                ...
                <div class="box-body">
                  <div class="form-group">
                    <div class="col-xs-offset-2">
                      <label class="col-sm-3 control-label" for="">Nomor Pustaka</label>
                      <div class="col-xs-2 input-group">
                        <span class="input-group-addon">
                          <i class="fa fa-book"></i>
                        </span>
                        <input type="number" class="form-control" id="exampleInputPassword1" name="nomorpustaka" required>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-xs-offset-2">
                      <label class="col-sm-3 control-label" for="">Nomor Anggota</label>
                      <div class="col-xs-4 input-group">
                        <span class="input-group-addon">
                          <i class="fa fa-user"></i>
                        </span>
                        <input type="number" class="form-control" id="exampleInputEmail1" name="nomoranggota" required>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-xs-12 text-center">
            <a href="transaksi.php" class="btn btn-default" style="margin-right: 20px;">Kembali</a>
