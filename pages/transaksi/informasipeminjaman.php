...
<head>
  ...
  <title>SIMPERPUS | Informasi Peminjaman</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <?php
      $peminjaman = mysqli_query($koneksi,"SELECT * FROM t_peminjaman WHERE id_pmnjmn = '$id'");
      while($pmnjn = mysqli_fetch_array($peminjaman)){
        $idpustaka = $pmnjn['id_dp'];
        $datapustaka = mysqli_query($koneksi, "SELECT * FROM t_datapustaka WHERE id_dp = '$idpustaka'");
        $dp = mysqli_fetch_assoc($datapustaka);
        $idanggota = $pmnjn['id_anggota'];
        $dataanggota = mysqli_query($koneksi, "SELECT * FROM t_dataanggota WHERE id_anggota = '$idanggota'");
        $da = mysqli_fetch_assoc($dataanggota);
        $idadmin = $pmnjn['id_pengguna'];
        $dataadmin = mysqli_query($koneksi, "SELECT * FROM t_datapengguna WHERE id_pengguna = '$idadmin'");
        $dadmin = mysqli_fetch_assoc($dataadmin);
     ?>
    <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        Informasi Peminjaman
        <small>#<?php echo $pmnjn['nomor_pmnjmn']; ?></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="../../index.php"><i class="fa fa-home"></i> Beranda</a></li>
        <li><a href="transaksi.php">Transaksi</a></li>
        <li class="active">Informasi Peminjaman</li>
      </ol>
    </section>
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            ...
            <small class="pull-right">Nomor Pustaka: #<?php echo $dp['id_dp'] ?></small>
          </h2>
        </div>
        <!-- /.col -->
      </div>
        ...
        <div class="col-xs-12">
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tr>
                <th>ISBN </th>
                <td><?php echo $dp['isbn']; ?></td>
              </tr>
              <tr>
                <th>Klasifikasi </th>
                <td><?php echo $dp['klasifikasi']; ?></td>
              </tr>
              <tr>
                <th>Jumlah </th>
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            ...
            <small class="pull-right">Nomor Anggota: #<?php echo $da['no_anggota'] ?></small>
          </h2>
        </div>
        <!-- /.col -->
      </div>
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            ...
            <small class="pull-right">Nomor Peminjaman: #<?php echo $pmnjn['nomor_pmnjmn']; ?></small>
          </h2>
        </div>
        <!-- /.col -->
      </div>
          ...
          <div class="table-responsive">
            <table class="table table-striped">
              <tr>
                ...
                <td>#<?php echo $pmnjn['nomor_pmnjmn']; ?></td>
              </tr>
              <tr>
                <th>Admin</th>
                <td><?php echo $dadmin['nama_pengguna'] ?></td>
              </tr>
              <tr>
                <th>NIP</th>
                <td><?php echo $dadmin['nip'] ?></td>
              </tr>
              <tr>
                <th>Tanggal Pinjam</th>
                <td>
                  <?php
                    $tanggal = date("d/m/Y", strtotime($pmnjn['tgl_pjm']));
                    echo $tanggal;
                   ?>
                </td>
              </tr>
              <tr>
                ...
                <td><?php
                  $tanggal = date("d/m/Y", strtotime($pmnjn['tgl_kmbl']));
                  echo $tanggal;
                ?></td>
              </tr>
            </table>
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          <a href="<?php
            if ($_SESSION['idpengguna'] == 1) {
              echo "../../index.php";
            } else {
              echo "transaksi.php";
            }
           ?>" class="btn btn-default" style="margin-right: 10px;">Kembali</a>
        </div>
      </div>
      <?php
        }
