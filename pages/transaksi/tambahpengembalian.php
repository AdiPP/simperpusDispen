...
<?php
  ...
  if (isset($_GET['pesan'])) {
    if ($_GET['pesan'] == "tidakditemukan") {
      $display = "";
      $pesan = "Nomor Peminjaman tidak ditemukan.";
    }
  }
...
<head>
  ...
  <title>SIMPERPUS | Tambah Pengembalian</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        <form class="form-horizontal" role="form" method="post" action="tambahpengembalian-cekdata.php">
        <div class="col-xs-12">
        </div>
          <div class="col-md-12">
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">Tambah Pengembalian</h3>
              </div>
              <!-- /.box-header -->
                <div class="box-body">
                  <div class="form-group">
                    <div class="col-xs-offset-2">
                      <label class="col-sm-3 control-label" for="">Nomor Peminjaman</label>
                      <div class="col-xs-4 input-group">
                        <span class="input-group-addon">
                          <i class="fa fa-upload"></i>
                        </span>
                        <input type="number" class="form-control" id="" name="nomorpeminjaman" required>
                      </div>
                    </div>
                  </div>
                <!-- /.box-body -->
