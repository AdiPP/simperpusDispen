...
<head>
  ...
  <title>SIMPERPUS | Informasi Pustaka</title>
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            ...
            <small class="pull-right">Nomor Pustaka: #<?php echo $p['id_dp'] ?></small>
          </h2>
        </div>
        <!-- /.col -->
      </div>
      ...
      <div class="row no-print">
        <div class="col-xs-12 text-center">
          <a href="datapustaka.php" class="btn btn-default" style="margin-right: 10px;">Kembali</a>
          <a onclick="deleteme(<?php echo $p['id_dp']; ?>)" class="btn btn-danger">Hapus</a>
        </div>
      </div>
      <?php
        }
