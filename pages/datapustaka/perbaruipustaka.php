...
<head>
  ...
  <title>SIMPERPUS | Perbarui Pustaka</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="datapustaka.php">Data Pustaka</a></li>
        <li class="active">Perbarui Pustaka</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        <?php
          $pustaka = mysqli_query($koneksi,"SELECT * FROM t_datapustaka WHERE id_dp = '$id'");
          while($p = mysqli_fetch_array($pustaka)){
         ?>
        <form class="form-horizontal" role="form" method="post" action="perbaruipustaka-proses.php">
          <div class="col-xs-12">
          </div>
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Perbarui Pustaka</h3>
                </div>
                <!-- /.box-header -->
                  <div class="box-body">
                    <input type="hidden" name="id" value="<?php echo $p['id_dp'] ?>">
                    <div class="form-group">
                      <label for="" class="col-sm-2 control-label">Judul Pustaka</label>
                      <div class="col-xs-10">
                        <input type="text" class="form-control" id="" name="juduldp" value="<?php echo $p['judul_dp'] ?>" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="" class="col-sm-2 control-label">Pengarang</label>
                      <div class="col-xs-6">
                        <input type="text" class="form-control" id="" name="pengarang" value="<?php echo $p['pengarang'] ?>" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="" class="col-sm-2 control-label">Penerbit</label>
                      <div class="col-xs-6">
                        <input type="text" class="form-control" id="" name="penerbit" value="<?php echo $p['penerbit'] ?>" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="" class="col-sm-2 control-label">Tahun</label>
                      <div class="col-xs-2">
                        <input type="number" class="form-control" id="" name="tahun" value="<?php echo $p['tahun'] ?>" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="" class="col-sm-2 control-label">ISBN</label>
                      <div class="col-xs-3">
                        <input type="text" class="form-control" id="" name="isbn" value="<?php echo $p['isbn'] ?>" onkeypress="isInputNumber(event)" maxlength="13" required>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-xs-4">
                        <select class="form-control" name="kategori" required>
                          ...
                          <option <?php if ($kategori == "Karya Umum") {
                            echo "selected";
                          } ?>>Karya Umum</option>
                          <option <?php if ($kategori == "Filsafat dan Psikologi") {
                            echo "selected";
                          } ?>>Filsafat dan Psikologi</option>
                          <option <?php if ($kategori == "Agama") {
                            echo "selected";
                          } ?>>Agama</option>
                          <option <?php if ($kategori == "Ilmu-ilmu Sosial") {
                            echo "selected";
                          } ?>>Ilmu-ilmu Sosial</option>
                          <option <?php if ($kategori == "Bahasa") {
                            echo "selected";
                          } ?>>Bahasa</option>
                          <option <?php if ($kategori == "Ilmu-ilmu Alam dan Matematika") {
                            echo "selected";
                          } ?>>Ilmu-ilmu Alam dan Matematika</option>
                          <option <?php if ($kategori == "Teknologi dan Ilmu-ilmu Terapan") {
                            echo "selected";
                          } ?>>Teknologi dan Ilmu-ilmu Terapan</option>
                          <option <?php if ($kategori == "Kesenian Hinburan dan Olahraga") {
                            echo "selected";
                          } ?>>Kesenian Hinburan dan Olahraga</option>
                          <option <?php if ($kategori == "Kesusastraan") {
                            echo "selected";
                          } ?>>Kesusastraan</option>
                          <option <?php if ($kategori == "Geografi dan Sejarah") {
                            echo "selected";
                          } ?>>Geografi dan Sejarah</option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-xs-2">
                        <input type="text" class="form-control" id="" name="klasifikasi" value="<?php echo $p['klasifikasi'] ?>" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="" class="col-sm-2 control-label">Jumlah</label>
                      <div class="col-xs-2">
                        <input type="number" class="form-control" id="" name="jumlah" value="<?php echo $p['jumlah'] ?>" required>
                      </div>
                    </div>
                  </div>
                  <!-- /.box-body -->
            ...
            <div class="col-xs-12 text-center">
              <a href="datapustaka.php" class="btn btn-default" style="margin-right: 20px;">Kembali ke Daftar Pustaka</a>
