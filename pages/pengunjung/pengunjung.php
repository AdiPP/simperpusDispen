...
<head>
  ...
  <title>SIMPERPUS | Data Kunjungan</title>
...
<div class="login-box">
  <div class="login-logo">
    ...
    <h6 class="lead">Dinas Pendidikan Kabupaten Banyumas</h6>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg <?php if ($_GET['pesan'] == "berhasil") {
      echo "text-green";
    } elseif ($_GET['pesan'] == "tidakditemukan") {
      echo "text-red";
    } ?>"><?php echo $pesan; ?></p>
    ...
    <form action="pengunjung-proses.php" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="pekerjaanpengunjung" placeholder="Pekerjaan" required>
        <span class="glyphicon glyphicon-briefcase form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="keperluanpengunjung" placeholder="Keperluan" required>
